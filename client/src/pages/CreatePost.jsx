      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          <FormField
            ...
            type="text"
            name="name"
            placeholder="Abdel-Rahman Rabee"
            value={form.name}
          ...
          <div className="relative bg-gray-50 border
           ...
           h-64 flex justify-content items-center ">
            {form.photo
              ? <img
                  src={form.photo}
                  alt={form.prompt}
            ...
            justify-center  item-center bg-[rgba(0,0,0,0.5)]
            rounded-lg">
                <Loader />
              </div>}
          </div>
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-[14px]">
            Okay once you created the image you want , so share the website with
            your friends don't be an asshole
          </p>
          <button
            type="submit"
            className="mt-3 text-white bg-[#6449ff]
            font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center "
          >
            {loading ? "Sharing..." : "Share with your friends bro !!!"}
          </button>
        </div>
      </form>
    </section>
